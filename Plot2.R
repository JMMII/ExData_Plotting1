...
Plot2Data <- transform(projData, DateTime = strptime(paste(projData$Date, substr(projData$Time,12,16)),format = "%Y-%m-%d %H:%M"))

#open graphics device, create filename and set width and height for Plot 2
png(filename = "Plot2.png", width = 480, height = 480)

#create the plot for Plot 2
with(Plot2Data, plot(DateTime, Global_active_power, type = "l", main = "", ylab = "Global Active Power (kilowatts)", xlab = "", col = "black"))

#turn off the graphics device for Plot 2
dev.off()
